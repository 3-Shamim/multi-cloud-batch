...
public class MergeHuaweiBillingDataJobConfig {

    private static final String JOB_NAME = "mergeHuaweiBillingDataJob";
    ...
    @Bean
    public Job mergeHuaweiBillingDataJob() {
    ...
    @Bean
    public Step mergeHuaweiBillingDataMasterStep() {

        return new StepBuilder("mergeHuaweiBillingDataMasterStep", jobRepository)
                .partitioner(mergeHuaweiBillingDataWorkerStep().getName(), mergeHuaweiBillingDataPartitioner())
                .step(mergeHuaweiBillingDataWorkerStep())
                .gridSize(1)
                .build();
    }

    @Bean
    public Partitioner mergeHuaweiBillingDataPartitioner() {
        ...
        return grid -> {
            ...
            List<String> allAccountIds = productAccountService.findAccountIds(orgId, CloudProvider.HWC);
    ...
    @Bean
    public Step mergeHuaweiBillingDataWorkerStep() {
        ...
        return new StepBuilder("mergeHuaweiBillingDataWorkerStep", jobRepository)
                ...
                .writer(records -> {
                    ...
                    if (orgId == null) {
                        throw new RuntimeException("Organization ID is required for mergeHuaweiBillingDataWorkerStep");
                    }

                    log.info("Writing {} huawei records to database", records.size());
    ...
    public ItemReader<ServiceLevelBilling> huaweiDataReader() {
        ...
        if (accountIds == null) {
            throw new RuntimeException("Account IDs are not set for huaweiDataReader");
        }
    ...
    private String createSQL(List<String> accountIds) {
        ...
        return ServiceLevelBillingSql.HUAWEI_SQL.formatted(placeholders);
    }
